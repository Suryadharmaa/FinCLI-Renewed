...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("/security encrypt-key", "Encrypt broker API key with master password.", "/security encrypt-key alpaca", "Security"),
    CommandSpec("/security decrypt-key", "Decrypt broker API key (requires master password).", "/security decrypt-key alpaca", "Security"),
    ...
    CommandSpec("/trading algo list", "Show available algo strategies.", "/trading algo list", "Trading"),
    CommandSpec("/trading algo run", "Run algo strategy and place paper order.", "/trading algo run sma_cross AAPL 1d", "Trading"),
    ...
    CommandSpec("/web", "Web research helper for public source queries.", "/web why is rupiah weakening", "Advanced"),
